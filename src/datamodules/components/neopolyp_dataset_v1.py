...
class NeoPolypDataset(Dataset):
    def __init__(
        ...
        data_path = os.path.join(self.data_dir, "bkai-igh-neopolyp")

        image_dir = os.path.join(data_path, "train/train")
        mask_dir = os.path.join(data_path, "train_gt/train_gt")
...
if __name__ == "__main__":
    train_dataset = NeoPolypDataset("./data/", mode="train")
    val_dataset = NeoPolypDataset("./data/", mode="val")
    test_dataset = NeoPolypDataset("./data/", mode="test")
