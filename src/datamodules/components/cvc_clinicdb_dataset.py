...
class CVCClinicDBDataset(Dataset):
    def __init__(
        ...
        data_path = os.path.join(self.data_dir, "CVC-ClinicDB/PNG")

        image_dir = os.path.join(data_path, "Original")
        mask_dir = os.path.join(data_path, "Ground Truth")
...
if __name__ == "__main__":
    train_dataset = CVCClinicDBDataset("./data/", mode="train")
    val_dataset = CVCClinicDBDataset("./data/", mode="val")
    test_dataset = CVCClinicDBDataset("./data/", mode="test")
