...
class StridedConvBlock(nn.Module):
    def __init__(self, in_c, out_c):
        ...
        self.conv = nn.Conv2d(
            in_c, out_c, kernel_size=(3, 3), stride=2, padding=1
        )
...
class ColonSegNet(nn.Module):
    def __init__(self, in_channels: int = 3, n_classes: int = 1):
        ...
        self.t1 = nn.ConvTranspose2d(
            256, 128, kernel_size=(4, 4), stride=4, padding=0
        )
        ...
        self.t4 = nn.ConvTranspose2d(
            64, 32, kernel_size=(4, 4), stride=2, padding=1
        )
        self.r4 = ResidualBlock(96, 32)
        """Output."""
        self.output = nn.Conv2d(32, n_classes, kernel_size=(1, 1), padding=0)
