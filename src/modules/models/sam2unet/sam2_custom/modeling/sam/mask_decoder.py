...
class MaskDecoder(nn.Module):
    ...
    def _dynamic_multimask_via_stability(
        ...
        """When outputting a single mask, if the stability score from the
        current single-mask output (based on output token 0) falls below a
        threshold, we instead select from multi-mask outputs (based on output
