...
class SAM2AutomaticMaskGenerator:
    def __init__(
        ...
        """Using a SAM 2 model, generates masks for the entire image. Generates
        a grid of point prompts over the image, then filters low quality and
        duplicate masks. The default settings are chosen for SAM 2 with a
        HieraL backbone.
        ...
        if output_mode == "coco_rle":
            try:
                from pycocotools import (  # type: ignore  # noqa: F401
                    mask as mask_utils,
                )
