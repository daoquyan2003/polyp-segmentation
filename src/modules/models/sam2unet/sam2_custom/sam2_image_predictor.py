...
from sam2_custom.utils.transforms import SAM2Transforms
...
class SAM2ImagePredictor:
    ...
    def set_image_batch(
        ...
        """Calculates the image embeddings for the provided image batch,
        allowing masks to be predicted with the 'predict_batch' method.
    ...
    def predict_batch(
        ...
        """This function is very similar to predict(...), however it is used
        for batched mode, when the model is expected to generate predictions on
        multiple images.
    ...
    def _predict(
        ...
        already be transformed to the input frame using SAM2Transforms.
